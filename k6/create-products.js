    ...
    variants: [
      {
        ...
        images: [
          { imagePath: "products/yoko/10w40-0.8l-front.jpg" },
          { imagePath: "products/yoko/10w40-0.8l-back.jpg" },
        ],
      },
      {
        name: "Chai 1L",
        ...
        images: [{ imagePath: "products/yoko/10w40-1l-front.jpg" }],
      },
    ],
  },
  {
    ...
    variants: [
      {
        ...
        images: [{ imagePath: "products/castrol/power1-0.8l.jpg" }],
      },
      {
        name: "Chai 1L",
        stock: 250,
        ...
        images: [{ imagePath: "products/castrol/power1-1l.jpg" }],
      },
      {
        ...
        images: [{ imagePath: "products/castrol/power1-thung-12.jpg" }],
      },
    ],
  },
  {
    ...
    variants: [
      {
        ...
        images: [
          { imagePath: "products/motul/7100-1l-front.jpg" },
          { imagePath: "products/motul/7100-1l-side.jpg" },
        ],
      },
      {
        name: "Chai 4L",
        ...
        images: [{ imagePath: "products/motul/7100-4l.jpg" }],
      },
    ],
  },
  {
    ...
    variants: [
      {
        ...
        images: [{ imagePath: "products/sonax/bot-tuyet-1l.jpg" }],
      },
      {
        name: "Can 5L",
        stock: 100,
        ...
        images: [{ imagePath: "products/sonax/bot-tuyet-5l.jpg" }],
      },
    ],
  },
  {
    ...
    variants: [
      {
        ...
        images: [{ imagePath: "products/michelin/city-grip2-90-90-14.jpg" }],
      },
      {
        ...
        images: [{ imagePath: "products/michelin/city-grip2-100-90-14.jpg" }],
      },
      {
        ...
        images: [{ imagePath: "products/michelin/city-grip2-120-70-14.jpg" }],
      },
    ],
  },
];
